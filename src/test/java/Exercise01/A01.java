...
public class A01 {
  ...
  //2. Navigate to url 'http://automationexercise.com'
    ...
    public void homePageTest() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@type='text']")).sendKeys("13mahmut_dogabilemez");
        driver.findElement(By.xpath("(//input[@type='email'])[2]")).sendKeys("13mahmut_dogabilemez@gmail.com");
       ...
       // 9. Fill details: Title, Name, Email, Password, Date of birth
        ...
        //First name
        driver.findElement(By.xpath("//input[@id='first_name']")).sendKeys("Mahmut");
        Thread.sleep(1000);
        //Last Name
        driver.findElement(By.xpath("//input[@id='last_name']")).sendKeys("Dogabilemez");
        Thread.sleep(1000);
        //Company
    ...
    //    if there is a popup add, close ad
        ...
        WebElement username=   driver.findElement(By.xpath("//*[text() ='13mahmut_dogabilemez'] "));
